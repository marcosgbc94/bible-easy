...
import { BibleRepositoryImp } from "@/Infrastructure/Repository/BibleRepositoryImp";
import { BibleDataSource } from "@/Domain/DataSource/BibleDataSource";
import { BibleDataSourceImp } from "@/Infrastructure/DataSource/BibleDataSourceImp";
